...
public class Journal extends TableImpl<JournalRecord> {
  ...
  public final TableField<JournalRecord, String> ID =
      createField(DSL.name("id"), SQLDataType.CLOB.nullable(false), this, "");

  /** The column <code>public.journal.event</code>. */
  public final TableField<JournalRecord, JSONB> EVENT =
      createField(DSL.name("event"), SQLDataType.JSONB.nullable(false), this, "");

  /** The column <code>public.journal.sequence</code>. */
  public final TableField<JournalRecord, Long> SEQUENCE =
      createField(DSL.name("sequence"), SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>public.journal.global_sequence</code>. */
  public final TableField<JournalRecord, Long> GLOBAL_SEQUENCE =
      createField(
          DSL.name("global_sequence"),
          SQLDataType.BIGINT
              .nullable(false)
              .defaultValue(
                  DSL.field(DSL.raw("nextval('journal_sequence'::regclass)"), SQLDataType.BIGINT)),
          this,
          "");

  /** The column <code>public.journal.shard</code>. */
  public final TableField<JournalRecord, Long> SHARD =
      createField(DSL.name("shard"), SQLDataType.BIGINT.nullable(false), this, "");

  /** The column <code>public.journal.occured</code>. */
  public final TableField<JournalRecord, LocalDateTime> OCCURED =
      createField(DSL.name("occured"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");

  /** The column <code>public.journal.type</code>. */
  public final TableField<JournalRecord, String> TYPE =
  ...
  private Journal(
      Name alias, Table<JournalRecord> aliased, Field<?>[] parameters, Condition where) {
