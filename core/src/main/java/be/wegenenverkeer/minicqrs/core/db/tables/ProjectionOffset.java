...
public class ProjectionOffset extends TableImpl<ProjectionOffsetRecord> {
     ...
     */
    public final TableField<ProjectionOffsetRecord, String> PROJECTION = createField(DSL.name("projection"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.projection_offset.shard</code>.
     */
    public final TableField<ProjectionOffsetRecord, Long> SHARD = createField(DSL.name("shard"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.projection_offset.sequence</code>.
     */
    public final TableField<ProjectionOffsetRecord, Long> SEQUENCE = createField(DSL.name("sequence"), SQLDataType.BIGINT.nullable(false), this, "");

    private ProjectionOffset(Name alias, Table<ProjectionOffsetRecord> aliased) {
        this(alias, aliased, (Field<?>[]) null, null);
    }

    private ProjectionOffset(Name alias, Table<ProjectionOffsetRecord> aliased, Field<?>[] parameters, Condition where) {
