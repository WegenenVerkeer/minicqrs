...
public class Snapshot extends TableImpl<SnapshotRecord> {
     ...
     */
    public final TableField<SnapshotRecord, String> ID = createField(DSL.name("id"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>public.snapshot.snapshot</code>.
     */
    public final TableField<SnapshotRecord, JSONB> SNAPSHOT_ = createField(DSL.name("snapshot"), SQLDataType.JSONB.nullable(false), this, "");

    /**
     * The column <code>public.snapshot.sequence</code>.
     */
    public final TableField<SnapshotRecord, Long> SEQUENCE = createField(DSL.name("sequence"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.snapshot.type</code>.
     */
    public final TableField<SnapshotRecord, String> TYPE = createField(DSL.name("type"), SQLDataType.CLOB.nullable(false), this, "");

    private Snapshot(Name alias, Table<SnapshotRecord> aliased) {
        this(alias, aliased, (Field<?>[]) null, null);
    }

    private Snapshot(Name alias, Table<SnapshotRecord> aliased, Field<?>[] parameters, Condition where) {
