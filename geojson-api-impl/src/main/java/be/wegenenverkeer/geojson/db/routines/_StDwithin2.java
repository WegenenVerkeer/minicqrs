...
public class _StDwithin2 extends AbstractRoutine<Boolean> {
  ...
  /** The parameter <code>public._st_dwithin.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public._st_dwithin.tolerance</code>. */
  public static final Parameter<Double> TOLERANCE =
      Internal.createParameter("tolerance", SQLDataType.DOUBLE, false, false);

  /** The parameter <code>public._st_dwithin.use_spheroid</code>. */
  ...
  public _StDwithin2() {
    super("_st_dwithin", Public.PUBLIC, SQLDataType.BOOLEAN);
