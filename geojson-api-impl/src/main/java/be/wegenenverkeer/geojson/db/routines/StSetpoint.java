...
public class StSetpoint extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_setpoint.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_setpoint._1</code>. */
  ...
  /** The parameter <code>public.st_setpoint._3</code>. */
  ...
  public StSetpoint() {
    super("st_setpoint", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
