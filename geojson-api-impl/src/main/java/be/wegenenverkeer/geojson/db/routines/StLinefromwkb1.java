...
public class StLinefromwkb1 extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_linefromwkb.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_linefromwkb._1</code>. */
  public static final Parameter<byte[]> _1 =
      Internal.createParameter("_1", SQLDataType.BLOB, false, true);

  /** The parameter <code>public.st_linefromwkb._2</code>. */
  ...
  public StLinefromwkb1() {
    super("st_linefromwkb", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
