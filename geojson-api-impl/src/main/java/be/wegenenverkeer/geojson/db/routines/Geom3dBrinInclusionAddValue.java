...
public class Geom3dBrinInclusionAddValue extends AbstractRoutine<Boolean> {
  ...
  /** The parameter <code>public.geom3d_brin_inclusion_add_value.RETURN_VALUE</code>. */
   ...
   */
  @Deprecated
  public static final Parameter<Object> _4 =
      Internal.createParameter(
          "_4", DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""), false, true);

  /** Create a new routine call instance */
  public Geom3dBrinInclusionAddValue() {
    super("geom3d_brin_inclusion_add_value", Public.PUBLIC, SQLDataType.BOOLEAN);
