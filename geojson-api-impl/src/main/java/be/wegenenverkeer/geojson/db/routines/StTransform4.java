...
public class StTransform4 extends AbstractRoutine<Geometry<?>> {
  ...
  public static final Parameter<Integer> TO_SRID =
      Internal.createParameter("to_srid", SQLDataType.INTEGER, false, false);
  ...
  /**
   * Set the <code>to_srid</code> parameter to the function to be used with a {@link
   * org.jooq.Select} statement
   */
