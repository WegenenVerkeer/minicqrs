...
public class StShiftlongitude extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_shiftlongitude.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_shiftlongitude._1</code>. */
  ...
  public StShiftlongitude() {
    super("st_shiftlongitude", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
