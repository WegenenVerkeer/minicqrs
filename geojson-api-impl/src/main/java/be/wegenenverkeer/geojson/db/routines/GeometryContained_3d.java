...
public class GeometryContained_3d extends AbstractRoutine<Boolean> {
  ...
  public GeometryContained_3d() {
    super("geometry_contained_3d", Public.PUBLIC, SQLDataType.BOOLEAN);
