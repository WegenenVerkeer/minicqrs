...
public class StGeometryfromtext2 extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_geometryfromtext.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_geometryfromtext._1</code>. */
  public static final Parameter<String> _1 =
      Internal.createParameter("_1", SQLDataType.CLOB, false, true);

  /** The parameter <code>public.st_geometryfromtext._2</code>. */
  ...
  public StGeometryfromtext2() {
    super("st_geometryfromtext", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
