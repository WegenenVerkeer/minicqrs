...
public class StLinecrossingdirection extends AbstractRoutine<Integer> {
  ...
  /** The parameter <code>public.st_linecrossingdirection.line1</code>. */
  public static final Parameter<Geometry<?>> LINE1 =
      Internal.createParameter(
          "line1", SQLDataType.OTHER, false, false, new GeolatteGeometryConverter());

  /** The parameter <code>public.st_linecrossingdirection.line2</code>. */
  ...
  public StLinecrossingdirection() {
    super("st_linecrossingdirection", Public.PUBLIC, SQLDataType.INTEGER);
