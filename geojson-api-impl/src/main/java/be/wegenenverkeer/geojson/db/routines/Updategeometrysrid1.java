...
public class Updategeometrysrid1 extends AbstractRoutine<String> {
  ...
  public static final Parameter<String> CATALOGN_NAME =
      Internal.createParameter("catalogn_name", SQLDataType.VARCHAR, false, false);
  ...
  /**
   * Set the <code>catalogn_name</code> parameter to the function to be used with a {@link
