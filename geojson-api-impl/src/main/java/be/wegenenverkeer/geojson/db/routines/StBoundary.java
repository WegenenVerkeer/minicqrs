...
public class StBoundary extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_boundary.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_boundary._1</code>. */
  ...
  public StBoundary() {
    super("st_boundary", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
