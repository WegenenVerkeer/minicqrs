...
public class StMpointfromtext2 extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_mpointfromtext.RETURN_VALUE</code>. */
  ...
  public StMpointfromtext2() {
    super("st_mpointfromtext", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
