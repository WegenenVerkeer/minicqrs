...
public class Addgeometrycolumn3 extends AbstractRoutine<String> {
  ...
  public static final Parameter<Integer> NEW_SRID =
      Internal.createParameter("new_srid", SQLDataType.INTEGER, false, false);
  ...
  /**
   * Set the <code>new_srid</code> parameter to the function to be used with a {@link
   * org.jooq.Select} statement
   */
