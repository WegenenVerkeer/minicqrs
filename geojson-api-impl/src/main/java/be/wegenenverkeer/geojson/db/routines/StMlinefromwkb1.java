...
public class StMlinefromwkb1 extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_mlinefromwkb.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_mlinefromwkb._1</code>. */
  public static final Parameter<byte[]> _1 =
      Internal.createParameter("_1", SQLDataType.BLOB, false, true);

  /** The parameter <code>public.st_mlinefromwkb._2</code>. */
  ...
  public StMlinefromwkb1() {
    super("st_mlinefromwkb", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
