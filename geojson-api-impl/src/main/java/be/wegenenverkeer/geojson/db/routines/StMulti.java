...
public class StMulti extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_multi.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_multi._1</code>. */
  ...
  public StMulti() {
    super("st_multi", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
