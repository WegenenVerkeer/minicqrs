...
public class GeometrySpgistLeafConsistentNd extends AbstractRoutine<Boolean> {
  ...
  /** The parameter <code>public.geometry_spgist_leaf_consistent_nd.RETURN_VALUE</code>. */
  ...
  public GeometrySpgistLeafConsistentNd() {
    super("geometry_spgist_leaf_consistent_nd", Public.PUBLIC, SQLDataType.BOOLEAN);
