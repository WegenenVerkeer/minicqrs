...
public class GserializedGistJoinsel_2d extends AbstractRoutine<Double> {
  ...
  public static final Parameter<Long> _2 =
      Internal.createParameter("_2", SQLDataType.BIGINT, false, true);
  ...
  public static final Parameter<Object> _3 =
      Internal.createParameter(
          "_3", DefaultDataType.getDefaultDataType("\"pg_catalog\".\"internal\""), false, true);

  /** The parameter <code>public.gserialized_gist_joinsel_2d._4</code>. */
  public static final Parameter<Short> _4 =
      Internal.createParameter("_4", SQLDataType.SMALLINT, false, true);

  /** Create a new routine call instance */
  public GserializedGistJoinsel_2d() {
    super("gserialized_gist_joinsel_2d", Public.PUBLIC, SQLDataType.DOUBLE);
