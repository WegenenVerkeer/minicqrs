...
public class Addgeometrycolumn1 extends AbstractRoutine<String> {
  ...
  public static final Parameter<Integer> NEW_SRID_IN =
      Internal.createParameter("new_srid_in", SQLDataType.INTEGER, false, false);

  /** The parameter <code>public.addgeometrycolumn.new_type</code>. */
  public static final Parameter<String> NEW_TYPE =
      Internal.createParameter("new_type", SQLDataType.VARCHAR, false, false);

  /** The parameter <code>public.addgeometrycolumn.new_dim</code>. */
  public static final Parameter<Integer> NEW_DIM =
      Internal.createParameter("new_dim", SQLDataType.INTEGER, false, false);
  ...
  /**
   * Set the <code>new_srid_in</code> parameter to the function to be used with a {@link
   * org.jooq.Select} statement
   */
  ...
  /**
   * Set the <code>new_type</code> parameter to the function to be used with a {@link
   * org.jooq.Select} statement
   */
  ...
  /**
   * Set the <code>new_dim</code> parameter to the function to be used with a {@link
   * org.jooq.Select} statement
   */
