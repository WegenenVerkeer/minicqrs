...
public class StMultilinefromwkb extends AbstractRoutine<Geometry<?>> {
  ...
  public StMultilinefromwkb() {
    super("st_multilinefromwkb", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
