...
public class StBuildarea extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_buildarea.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_buildarea._1</code>. */
  ...
  public StBuildarea() {
    super("st_buildarea", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
