...
public class _St_3ddwithin extends AbstractRoutine<Boolean> {
  ...
  public _St_3ddwithin() {
    super("_st_3ddwithin", Public.PUBLIC, SQLDataType.BOOLEAN);
