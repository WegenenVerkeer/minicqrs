...
public class GeometryGistDistanceNd extends AbstractRoutine<Double> {
  ...
  /** The parameter <code>public.geometry_gist_distance_nd.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.geometry_gist_distance_nd._2</code>. */
  public static final Parameter<Geometry<?>> _2 =
      Internal.createParameter(
          "_2", SQLDataType.OTHER, false, true, new GeolatteGeometryConverter());

  /** The parameter <code>public.geometry_gist_distance_nd._3</code>. */
  ...
  public GeometryGistDistanceNd() {
    super("geometry_gist_distance_nd", Public.PUBLIC, SQLDataType.DOUBLE);
