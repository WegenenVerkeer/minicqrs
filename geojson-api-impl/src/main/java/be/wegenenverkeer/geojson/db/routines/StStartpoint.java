...
public class StStartpoint extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_startpoint.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_startpoint._1</code>. */
  ...
  public StStartpoint() {
    super("st_startpoint", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
