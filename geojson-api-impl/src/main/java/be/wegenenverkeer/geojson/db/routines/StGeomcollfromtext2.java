...
public class StGeomcollfromtext2 extends AbstractRoutine<Geometry<?>> {
  ...
  public StGeomcollfromtext2() {
    super("st_geomcollfromtext", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
