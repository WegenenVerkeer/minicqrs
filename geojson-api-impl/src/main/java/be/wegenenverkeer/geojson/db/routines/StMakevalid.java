...
public class StMakevalid extends AbstractRoutine<Geometry<?>> {
  ...
  /** The parameter <code>public.st_makevalid._1</code>. */
  ...
  public StMakevalid() {
    super("st_makevalid", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
