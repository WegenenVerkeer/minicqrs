...
public class StCleangeometry extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_cleangeometry.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_cleangeometry._1</code>. */
  ...
  public StCleangeometry() {
    super("st_cleangeometry", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
