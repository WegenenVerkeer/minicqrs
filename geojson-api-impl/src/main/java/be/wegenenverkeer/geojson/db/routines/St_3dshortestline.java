...
public class St_3dshortestline extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_3dshortestline.RETURN_VALUE</code>. */
  ...
  public St_3dshortestline() {
    super("st_3dshortestline", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
