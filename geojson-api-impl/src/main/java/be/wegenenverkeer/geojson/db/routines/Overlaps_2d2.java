...
public class Overlaps_2d2 extends AbstractRoutine<Boolean> {
  ...
  /** The parameter <code>public.overlaps_2d.RETURN_VALUE</code>. */
  ...
  public static final Parameter<Object> _1 =
      Internal.createParameter(
          "_1", DefaultDataType.getDefaultDataType("\"public\".\"box2df\""), false, true);
  ...
  public static final Parameter<Object> _2 =
      Internal.createParameter(
          "_2", DefaultDataType.getDefaultDataType("\"public\".\"box2df\""), false, true);

  /** Create a new routine call instance */
  public Overlaps_2d2() {
    super("overlaps_2d", Public.PUBLIC, SQLDataType.BOOLEAN);
