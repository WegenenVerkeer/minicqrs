...
public class StExteriorring extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_exteriorring.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_exteriorring._1</code>. */
  ...
  public StExteriorring() {
    super("st_exteriorring", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
