...
public class _StDistancetree1 extends AbstractRoutine<Double> {
  ...
  /** The parameter <code>public._st_distancetree._3</code>. */
  public static final Parameter<Double> _3 =
      Internal.createParameter("_3", SQLDataType.DOUBLE, false, true);

  /** The parameter <code>public._st_distancetree._4</code>. */
  ...
  public _StDistancetree1() {
    super("_st_distancetree", Public.PUBLIC, SQLDataType.DOUBLE);
