...
public class GeometrySpgistLeafConsistent_3d extends AbstractRoutine<Boolean> {
  ...
  /** The parameter <code>public.geometry_spgist_leaf_consistent_3d.RETURN_VALUE</code>. */
  ...
  public GeometrySpgistLeafConsistent_3d() {
    super("geometry_spgist_leaf_consistent_3d", Public.PUBLIC, SQLDataType.BOOLEAN);
