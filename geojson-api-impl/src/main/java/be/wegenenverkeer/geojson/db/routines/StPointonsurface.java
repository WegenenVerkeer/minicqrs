...
public class StPointonsurface extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_pointonsurface.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_pointonsurface._1</code>. */
  ...
  public StPointonsurface() {
    super("st_pointonsurface", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
