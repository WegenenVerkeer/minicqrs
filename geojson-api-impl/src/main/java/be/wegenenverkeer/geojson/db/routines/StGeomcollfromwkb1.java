...
public class StGeomcollfromwkb1 extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_geomcollfromwkb.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_geomcollfromwkb._1</code>. */
  public static final Parameter<byte[]> _1 =
      Internal.createParameter("_1", SQLDataType.BLOB, false, true);

  /** The parameter <code>public.st_geomcollfromwkb._2</code>. */
  ...
  public StGeomcollfromwkb1() {
    super("st_geomcollfromwkb", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
