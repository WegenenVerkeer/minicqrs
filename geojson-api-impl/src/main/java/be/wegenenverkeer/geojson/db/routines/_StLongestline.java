...
public class _StLongestline extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public._st_longestline.RETURN_VALUE</code>. */
  ...
  public _StLongestline() {
    super("_st_longestline", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
