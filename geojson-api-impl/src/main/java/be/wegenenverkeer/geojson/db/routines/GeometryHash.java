...
public class GeometryHash extends AbstractRoutine<Integer> {
  ...
  public GeometryHash() {
    super("geometry_hash", Public.PUBLIC, SQLDataType.INTEGER);
