...
public class _St_3ddfullywithin extends AbstractRoutine<Boolean> {
  ...
  public _St_3ddfullywithin() {
    super("_st_3ddfullywithin", Public.PUBLIC, SQLDataType.BOOLEAN);
