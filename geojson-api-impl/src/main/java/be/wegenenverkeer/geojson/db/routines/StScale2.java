...
public class StScale2 extends AbstractRoutine<Geometry<?>> {
  ...
  public static final Parameter<Geometry<?>> ORIGIN =
      Internal.createParameter(
          "origin", SQLDataType.OTHER, false, false, new GeolatteGeometryConverter());

  /** Create a new routine call instance */
  public StScale2() {
    super("st_scale", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
