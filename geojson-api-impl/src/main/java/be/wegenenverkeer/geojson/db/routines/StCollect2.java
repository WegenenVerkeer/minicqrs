...
public class StCollect2 extends AbstractRoutine<Geometry<?>> {
  ...
  /** The parameter <code>public.st_collect._1</code>. */
  public static final Parameter<Object[]> _1 =
      Internal.createParameter("_1", SQLDataType.OTHER.array(), false, true);

  /** Create a new routine call instance */
  public StCollect2() {
    super("st_collect", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
