...
public class StMlinefromtext1 extends AbstractRoutine<Geometry<?>> {
  ...
  /** The parameter <code>public.st_mlinefromtext._2</code>. */
  ...
  public StMlinefromtext1() {
    super("st_mlinefromtext", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
