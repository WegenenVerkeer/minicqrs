...
public class GeographySpgistLeafConsistentNd extends AbstractRoutine<Boolean> {
  ...
  /** The parameter <code>public.geography_spgist_leaf_consistent_nd.RETURN_VALUE</code>. */
  ...
  public GeographySpgistLeafConsistentNd() {
    super("geography_spgist_leaf_consistent_nd", Public.PUBLIC, SQLDataType.BOOLEAN);
