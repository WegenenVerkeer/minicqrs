...
public class OverlapsGeog1 extends AbstractRoutine<Boolean> {
  ...
  /** The parameter <code>public.overlaps_geog.RETURN_VALUE</code>. */
  ...
  public static final Parameter<Object> _1 =
      Internal.createParameter(
          "_1", DefaultDataType.getDefaultDataType("\"public\".\"gidx\""), false, true);
  ...
  public OverlapsGeog1() {
    super("overlaps_geog", Public.PUBLIC, SQLDataType.BOOLEAN);
