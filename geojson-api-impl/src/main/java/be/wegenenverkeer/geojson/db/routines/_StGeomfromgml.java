...
public class _StGeomfromgml extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public._st_geomfromgml.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public._st_geomfromgml._1</code>. */
  public static final Parameter<String> _1 =
      Internal.createParameter("_1", SQLDataType.CLOB, false, true);

  /** The parameter <code>public._st_geomfromgml._2</code>. */
  ...
  public _StGeomfromgml() {
    super("_st_geomfromgml", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
