...
public class StMultipointfromwkb1 extends AbstractRoutine<Geometry<?>> {
  ...
  /** The parameter <code>public.st_multipointfromwkb._2</code>. */
  ...
  public StMultipointfromwkb1() {
    super(
        "st_multipointfromwkb", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
