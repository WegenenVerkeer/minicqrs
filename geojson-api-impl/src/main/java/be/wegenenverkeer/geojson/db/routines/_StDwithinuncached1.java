...
public class _StDwithinuncached1 extends AbstractRoutine<Boolean> {
  ...
  /** The parameter <code>public._st_dwithinuncached.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public._st_dwithinuncached._3</code>. */
  public static final Parameter<Double> _3 =
      Internal.createParameter("_3", SQLDataType.DOUBLE, false, true);

  /** The parameter <code>public._st_dwithinuncached._4</code>. */
  ...
  public _StDwithinuncached1() {
    super("_st_dwithinuncached", Public.PUBLIC, SQLDataType.BOOLEAN);
