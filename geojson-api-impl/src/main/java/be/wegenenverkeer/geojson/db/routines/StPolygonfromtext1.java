...
public class StPolygonfromtext1 extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_polygonfromtext.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_polygonfromtext._1</code>. */
  public static final Parameter<String> _1 =
      Internal.createParameter("_1", SQLDataType.CLOB, false, true);

  /** The parameter <code>public.st_polygonfromtext._2</code>. */
  ...
  public StPolygonfromtext1() {
    super("st_polygonfromtext", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
