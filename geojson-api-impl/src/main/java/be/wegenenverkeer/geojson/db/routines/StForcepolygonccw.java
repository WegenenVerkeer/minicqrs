...
public class StForcepolygonccw extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_forcepolygonccw.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_forcepolygonccw._1</code>. */
  ...
  public StForcepolygonccw() {
    super("st_forcepolygonccw", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
