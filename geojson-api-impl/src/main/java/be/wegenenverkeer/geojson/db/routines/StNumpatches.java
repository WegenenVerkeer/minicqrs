...
public class StNumpatches extends AbstractRoutine<Integer> {
  ...
  public StNumpatches() {
    super("st_numpatches", Public.PUBLIC, SQLDataType.INTEGER);
