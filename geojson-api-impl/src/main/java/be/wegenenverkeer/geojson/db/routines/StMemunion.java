...
public class StMemunion extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_memunion.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_memunion._1</code>. */
  ...
  public StMemunion() {
    super("st_memunion", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
