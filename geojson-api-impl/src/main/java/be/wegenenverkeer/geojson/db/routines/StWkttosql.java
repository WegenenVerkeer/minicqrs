...
public class StWkttosql extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_wkttosql.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_wkttosql._1</code>. */
  public static final Parameter<String> _1 =
      Internal.createParameter("_1", SQLDataType.CLOB, false, true);

  /** Create a new routine call instance */
  public StWkttosql() {
    super("st_wkttosql", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
