...
public class StFlipcoordinates extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_flipcoordinates.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_flipcoordinates._1</code>. */
  ...
  public StFlipcoordinates() {
    super("st_flipcoordinates", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
