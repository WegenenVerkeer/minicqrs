...
public class StMpolyfromwkb1 extends AbstractRoutine<Geometry<?>> {
  ...
  /** The parameter <code>public.st_mpolyfromwkb._2</code>. */
  ...
  public StMpolyfromwkb1() {
    super("st_mpolyfromwkb", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
