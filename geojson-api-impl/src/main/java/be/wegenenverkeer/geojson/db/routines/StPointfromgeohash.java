...
public class StPointfromgeohash extends AbstractRoutine<Geometry<?>> {
  ...
  public StPointfromgeohash() {
    super("st_pointfromgeohash", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
