...
public class _StOrderingequals extends AbstractRoutine<Boolean> {
  ...
  public _StOrderingequals() {
    super("_st_orderingequals", Public.PUBLIC, SQLDataType.BOOLEAN);
