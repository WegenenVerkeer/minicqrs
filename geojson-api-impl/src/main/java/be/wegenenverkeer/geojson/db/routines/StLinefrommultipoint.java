...
public class StLinefrommultipoint extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_linefrommultipoint.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_linefrommultipoint._1</code>. */
  ...
  public StLinefrommultipoint() {
    super(
        "st_linefrommultipoint", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
