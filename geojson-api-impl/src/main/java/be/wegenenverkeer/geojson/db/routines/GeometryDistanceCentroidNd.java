...
public class GeometryDistanceCentroidNd extends AbstractRoutine<Double> {
  ...
  public GeometryDistanceCentroidNd() {
    super("geometry_distance_centroid_nd", Public.PUBLIC, SQLDataType.DOUBLE);
