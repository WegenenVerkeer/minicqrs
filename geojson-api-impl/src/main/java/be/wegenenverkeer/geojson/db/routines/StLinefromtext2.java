...
public class StLinefromtext2 extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_linefromtext.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_linefromtext._1</code>. */
  public static final Parameter<String> _1 =
      Internal.createParameter("_1", SQLDataType.CLOB, false, true);

  /** The parameter <code>public.st_linefromtext._2</code>. */
  ...
  public StLinefromtext2() {
    super("st_linefromtext", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
