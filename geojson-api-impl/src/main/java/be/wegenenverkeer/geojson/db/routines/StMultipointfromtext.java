...
public class StMultipointfromtext extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_multipointfromtext.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_multipointfromtext._1</code>. */
  ...
  public StMultipointfromtext() {
    super(
        "st_multipointfromtext", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
