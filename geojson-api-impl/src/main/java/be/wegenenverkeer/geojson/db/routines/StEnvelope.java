...
public class StEnvelope extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_envelope.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_envelope._1</code>. */
  ...
  public StEnvelope() {
    super("st_envelope", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
