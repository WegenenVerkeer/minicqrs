...
public class StNuminteriorring extends AbstractRoutine<Integer> {
  ...
  public StNuminteriorring() {
    super("st_numinteriorring", Public.PUBLIC, SQLDataType.INTEGER);
