...
public class StLineinterpolatepoints extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_lineinterpolatepoints.RETURN_VALUE</code>. */
  ...
  public static final Parameter<Boolean> REPEAT =
      Internal.createParameter(
          "repeat",
  ...
  /**
   * Set the <code>repeat</code> parameter to the function to be used with a {@link org.jooq.Select}
   * statement
   */
