...
public class StForcecurve extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_forcecurve.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_forcecurve._1</code>. */
  ...
  public StForcecurve() {
    super("st_forcecurve", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
