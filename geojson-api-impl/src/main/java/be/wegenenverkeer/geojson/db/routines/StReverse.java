...
public class StReverse extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_reverse.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_reverse._1</code>. */
  ...
  public StReverse() {
    super("st_reverse", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
