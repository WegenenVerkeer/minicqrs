...
public class StMakepointm extends AbstractRoutine<Geometry<?>> {
  ...
  public static final Parameter<Double> _1 =
      Internal.createParameter("_1", SQLDataType.DOUBLE, false, true);
  ...
  public StMakepointm() {
    super("st_makepointm", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
