...
public class PostgisGeosNoop extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.postgis_geos_noop.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.postgis_geos_noop._1</code>. */
  ...
  public PostgisGeosNoop() {
    super("postgis_geos_noop", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
