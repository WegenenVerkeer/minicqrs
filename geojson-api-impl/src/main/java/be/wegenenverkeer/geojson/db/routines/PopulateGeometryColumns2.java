...
public class PopulateGeometryColumns2 extends AbstractRoutine<Integer> {
  ...
  public static final Parameter<Long> TBL_OID =
      Internal.createParameter("tbl_oid", SQLDataType.BIGINT, false, false);
  ...
  /**
   * Set the <code>tbl_oid</code> parameter to the function to be used with a {@link
