...
public class StShortestline extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_shortestline.RETURN_VALUE</code>. */
  ...
  public StShortestline() {
    super("st_shortestline", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
