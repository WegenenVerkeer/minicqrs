...
public class StAsgeojson2 extends AbstractRoutine<String> {
  ...
  public static final Parameter<Record> R =
      Internal.createParameter("r", SQLDataType.RECORD, false, false);

  /** The parameter <code>public.st_asgeojson.geom_column</code>. */
  public static final Parameter<String> GEOM_COLUMN =
  ...
  public static final Parameter<Boolean> PRETTY_BOOL =
      Internal.createParameter(
          "pretty_bool",
  ...
  /**
   * Set the <code>r</code> parameter to the function to be used with a {@link org.jooq.Select}
   * statement
   */
  ...
  /**
   * Set the <code>geom_column</code> parameter to the function to be used with a {@link
  ...
  /**
   * Set the <code>pretty_bool</code> parameter to the function to be used with a {@link
   * org.jooq.Select} statement
   */
