...
public class StMinimumclearance extends AbstractRoutine<Double> {
  ...
  public StMinimumclearance() {
    super("st_minimumclearance", Public.PUBLIC, SQLDataType.DOUBLE);
