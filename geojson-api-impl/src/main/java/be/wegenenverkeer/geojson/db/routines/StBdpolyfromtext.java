...
public class StBdpolyfromtext extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_bdpolyfromtext.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_bdpolyfromtext._1</code>. */
  public static final Parameter<String> _1 =
      Internal.createParameter("_1", SQLDataType.CLOB, false, true);

  /** The parameter <code>public.st_bdpolyfromtext._2</code>. */
  ...
  public StBdpolyfromtext() {
    super("st_bdpolyfromtext", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
