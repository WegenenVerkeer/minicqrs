...
public class StMpointfromwkb1 extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_mpointfromwkb.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_mpointfromwkb._1</code>. */
  public static final Parameter<byte[]> _1 =
      Internal.createParameter("_1", SQLDataType.BLOB, false, true);

  /** The parameter <code>public.st_mpointfromwkb._2</code>. */
  ...
  public StMpointfromwkb1() {
    super("st_mpointfromwkb", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
