...
public class StPoints extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_points.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_points._1</code>. */
  ...
  public StPoints() {
    super("st_points", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
