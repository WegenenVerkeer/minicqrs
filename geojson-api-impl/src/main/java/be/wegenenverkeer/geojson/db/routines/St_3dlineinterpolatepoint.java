...
public class St_3dlineinterpolatepoint extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_3dlineinterpolatepoint.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_3dlineinterpolatepoint._1</code>. */
  public static final Parameter<Geometry<?>> _1 =
      Internal.createParameter(
          "_1", SQLDataType.OTHER, false, true, new GeolatteGeometryConverter());

  /** The parameter <code>public.st_3dlineinterpolatepoint._2</code>. */
