...
public class StPointn extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_pointn.RETURN_VALUE</code>. */
