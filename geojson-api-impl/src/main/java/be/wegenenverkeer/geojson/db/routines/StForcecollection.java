...
public class StForcecollection extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_forcecollection.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_forcecollection._1</code>. */
  ...
  public StForcecollection() {
    super("st_forcecollection", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
