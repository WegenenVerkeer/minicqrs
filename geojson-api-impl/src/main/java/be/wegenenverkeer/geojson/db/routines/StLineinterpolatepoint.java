...
public class StLineinterpolatepoint extends AbstractRoutine<Geometry<?>> {
  ...
  /** The parameter <code>public.st_lineinterpolatepoint.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_lineinterpolatepoint._1</code>. */
  public static final Parameter<Geometry<?>> _1 =
      Internal.createParameter(
          "_1", SQLDataType.OTHER, false, true, new GeolatteGeometryConverter());

  /** The parameter <code>public.st_lineinterpolatepoint._2</code>. */
