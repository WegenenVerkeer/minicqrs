...
public class StSimplifypreservetopology extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_simplifypreservetopology.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_simplifypreservetopology._1</code>. */
  public static final Parameter<Geometry<?>> _1 =
      Internal.createParameter(
          "_1", SQLDataType.OTHER, false, true, new GeolatteGeometryConverter());

  /** The parameter <code>public.st_simplifypreservetopology._2</code>. */
