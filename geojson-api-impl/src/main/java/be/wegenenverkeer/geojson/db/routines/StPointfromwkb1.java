...
public class StPointfromwkb1 extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_pointfromwkb.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_pointfromwkb._1</code>. */
  public static final Parameter<byte[]> _1 =
      Internal.createParameter("_1", SQLDataType.BLOB, false, true);

  /** The parameter <code>public.st_pointfromwkb._2</code>. */
  ...
  public StPointfromwkb1() {
    super("st_pointfromwkb", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
