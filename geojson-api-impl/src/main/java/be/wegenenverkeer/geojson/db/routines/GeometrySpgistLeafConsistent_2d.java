...
public class GeometrySpgistLeafConsistent_2d extends AbstractRoutine<Boolean> {
  ...
  /** The parameter <code>public.geometry_spgist_leaf_consistent_2d.RETURN_VALUE</code>. */
  ...
  public GeometrySpgistLeafConsistent_2d() {
    super("geometry_spgist_leaf_consistent_2d", Public.PUBLIC, SQLDataType.BOOLEAN);
