...
public class StConvexhull extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_convexhull.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_convexhull._1</code>. */
  ...
  public StConvexhull() {
    super("st_convexhull", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
