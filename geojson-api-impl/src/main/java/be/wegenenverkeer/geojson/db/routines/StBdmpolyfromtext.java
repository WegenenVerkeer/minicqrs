...
public class StBdmpolyfromtext extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_bdmpolyfromtext.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_bdmpolyfromtext._1</code>. */
  public static final Parameter<String> _1 =
      Internal.createParameter("_1", SQLDataType.CLOB, false, true);

  /** The parameter <code>public.st_bdmpolyfromtext._2</code>. */
  ...
  public StBdmpolyfromtext() {
    super("st_bdmpolyfromtext", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
