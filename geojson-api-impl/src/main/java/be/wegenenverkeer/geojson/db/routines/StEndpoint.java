...
public class StEndpoint extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_endpoint.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_endpoint._1</code>. */
  ...
  public StEndpoint() {
    super("st_endpoint", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
