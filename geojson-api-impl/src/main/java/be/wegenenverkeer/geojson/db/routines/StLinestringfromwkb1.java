...
public class StLinestringfromwkb1 extends AbstractRoutine<Geometry<?>> {
  ...
  /** The parameter <code>public.st_linestringfromwkb._2</code>. */
  ...
  public StLinestringfromwkb1() {
    super(
        "st_linestringfromwkb", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
