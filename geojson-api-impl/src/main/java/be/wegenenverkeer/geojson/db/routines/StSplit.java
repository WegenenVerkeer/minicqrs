...
public class StSplit extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_split.RETURN_VALUE</code>. */
  ...
  public StSplit() {
    super("st_split", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
