...
public class StForce2d extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_force2d.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_force2d._1</code>. */
  ...
  public StForce2d() {
    super("st_force2d", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
