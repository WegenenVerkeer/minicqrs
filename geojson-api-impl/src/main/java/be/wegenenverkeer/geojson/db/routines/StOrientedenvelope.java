...
public class StOrientedenvelope extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_orientedenvelope.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_orientedenvelope._1</code>. */
  ...
  public StOrientedenvelope() {
    super("st_orientedenvelope", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
