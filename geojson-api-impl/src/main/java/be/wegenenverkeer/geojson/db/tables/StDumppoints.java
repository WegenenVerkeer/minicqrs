...
public class StDumppoints extends TableImpl<StDumppointsRecord> {
   ...
   */
  @Deprecated
  public final TableField<StDumppointsRecord, Object> ST_DUMPPOINTS_ =
      createField(
          DSL.name("st_dumppoints"),
  ...
  private StDumppoints(
      Name alias, Table<StDumppointsRecord> aliased, Field<?>[] parameters, Condition where) {
  ...
  public StDumppoints call(Field<Geometry<?>> __1) {
    StDumppoints result = new StDumppoints(DSL.name("st_dumppoints"), null, new Field[] {__1});
