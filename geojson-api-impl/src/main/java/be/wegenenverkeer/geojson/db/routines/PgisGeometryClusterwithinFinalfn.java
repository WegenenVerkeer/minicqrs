...
public class PgisGeometryClusterwithinFinalfn extends AbstractRoutine<Object[]> {
  ...
  /** The parameter <code>public.pgis_geometry_clusterwithin_finalfn.RETURN_VALUE</code>. */
  ...
  public PgisGeometryClusterwithinFinalfn() {
    super("pgis_geometry_clusterwithin_finalfn", Public.PUBLIC, SQLDataType.OTHER.array());
