...
public class StPolygonfromwkb1 extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_polygonfromwkb.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_polygonfromwkb._1</code>. */
  public static final Parameter<byte[]> _1 =
      Internal.createParameter("_1", SQLDataType.BLOB, false, true);

  /** The parameter <code>public.st_polygonfromwkb._2</code>. */
  ...
  public StPolygonfromwkb1() {
    super("st_polygonfromwkb", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
