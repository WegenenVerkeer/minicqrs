...
public class StInteriorringn extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_interiorringn.RETURN_VALUE</code>. */
  ...
  public StInteriorringn() {
    super("st_interiorringn", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
