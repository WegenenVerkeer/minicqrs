...
public class StAstwkb2 extends AbstractRoutine<byte[]> {
  ...
  public static final Parameter<Object[]> GEOM =
      Internal.createParameter("geom", SQLDataType.OTHER.array(), false, false);

  /** The parameter <code>public.st_astwkb.ids</code>. */
  public static final Parameter<Long[]> IDS =
      Internal.createParameter("ids", SQLDataType.BIGINT.array(), false, false);
  ...
  /**
   * Set the <code>ids</code> parameter to the function to be used with a {@link org.jooq.Select}
   * statement
   */
