...
public class StCollectionextract1 extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_collectionextract.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_collectionextract._1</code>. */
  public static final Parameter<Geometry<?>> _1 =
      Internal.createParameter(
          "_1", SQLDataType.OTHER, false, true, new GeolatteGeometryConverter());

  /** The parameter <code>public.st_collectionextract._2</code>. */
  public static final Parameter<Integer> _2 =
      Internal.createParameter("_2", SQLDataType.INTEGER, false, true);

  /** Create a new routine call instance */
  public StCollectionextract1() {
    super(
        "st_collectionextract", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
