...
public class StCentroid3 extends AbstractRoutine<Geometry<?>> {

  private static final long serialVersionUID = 1L;

  /** The parameter <code>public.st_centroid.RETURN_VALUE</code>. */
  ...
  /** The parameter <code>public.st_centroid._1</code>. */
  public static final Parameter<String> _1 =
      Internal.createParameter("_1", SQLDataType.CLOB, false, true);

  /** Create a new routine call instance */
  public StCentroid3() {
    super("st_centroid", Public.PUBLIC, SQLDataType.OTHER, new GeolatteGeometryConverter());
