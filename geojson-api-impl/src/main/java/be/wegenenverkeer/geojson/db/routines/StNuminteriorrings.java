...
public class StNuminteriorrings extends AbstractRoutine<Integer> {
  ...
  public StNuminteriorrings() {
    super("st_numinteriorrings", Public.PUBLIC, SQLDataType.INTEGER);
